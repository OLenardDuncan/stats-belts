...
local function draw()
	...
	for i = 0, #bouts-1 do
		...
		set_color(0, 0, 0, 1)
		draw_quad(window.w - (length + 72), 141 + (i * 18), 16, 16)

		set_color(belt.colour[1], belt.colour[2], belt.colour[3], belt.colour[4])
		draw_quad(window.w - (length + 71), 142 + (i * 18), 14, 14)
		
		set_color(1, 1, 1, 0.3)
		draw_quad(window.w - (length + 71), 142 + (i * 18), 14, 7)
		
		set_color(1, 1, 1, 1)
		draw_text(belt.shortname, window.w - (length + 64 + (get_string_length(belt.shortname, 1)/2)), 140 + (i * 18), 1)
	end
end
